function drawdiagramm(csvfilename) {

    const destcontainer = '#d3-container';

    //const csvfilename = "../../data/movimientos.csv";
    //const csvfilename = "../../data/humedades.csv";
    ...
    d3.csv(csvfilename,
        ...
        function (data) {
            ...
            data.forEach(function (d) {
                d.time = parseDate(d.time); //desde el string se hace un Datetype timestamp
            });



            data.sort((a, b) => a.time - b.time);//Ordenarlo cronologicamente

            // group the data: I want to draw one line per group
            var sumstat = d3.nest() // nest function allows to group the calculation per level of a factor
                .key(function (d) { return d.sensor; }) //cada sensor tiene su línea
                .entries(data);
            ...
            if (showtooltip) var tooltip = d3.select("#movimientos").append("div").attr("class", "toolTip");
