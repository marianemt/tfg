    ...
    1: [function (require, module, exports) {
        ...
        d3.floorplan = function () {
            ...
            map.sensorImageLayer = function (svgCanvas, floor, sensor) {
                ...
                // Context menu
                //console.log('XXXXSensor - ' + sensor.name);
                //var output = sensor.name + ':' + sensor.value;
                //console.log(output);
                ...
                var image = gSensorContainer.append("image")
                    ...
                    .attr("title", sensor.name);


                /*                var svgText = gSensorContainer.append("text");
                                svgText.attr("x", sensor.x + 0)
                                    .attr("y", sensor.y + 0)
                                    .attr('font-size', 12)
                                    .attr('font-weight', 400)
                                    .attr('font-family', 'sans-serif')
                ...
                */
                ...
                image.on('mouseover', d3.contextMenu(menu));
            };
